    ...
    return [
      ...
      },
      {
        ...
        payload: {
          ...
          json_attributes_topic: this._topic('payments/summary'),
          json_attributes_template:
            "{{ {'minutes': value_json.work_hours_today_minutes, 'date': value_json.work_hours_today_date, 'timezone': value_json.work_hours_timezone, 'timezone_source': value_json.work_hours_timezone_source, 'projects': value_json.work_hours_projects, 'entry_count': value_json.work_hours_entry_count, 'last_updated': value_json.work_hours_last_updated, 'complete': value_json.work_hours_complete, 'stale': value_json.work_hours_stale, 'allocation_method': value_json.work_hours_allocation_method} | tojson }}",
